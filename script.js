...
const saveUser = (userData) => {
    ...
    users.push(newUser) // adiciona um novo item no array
    return newUser // retorna o novo item
}
...
const startApp = () => {
    ...
    <main>
        <section class="about">
            ...
            <p>
                Um evento feito por e para pessoas desenvolvedoras apaixonadas por criar soluções inovadoras e
                compartilhar conhecimento. Vamos mergulhar nas tendências mais recentes em desenvolvimento de
                software, arquitetura de sistemas e tecnologias emergentes, com palestras, workshops e
                hackathons.
                <br><br>
